...
document.getElementById("your-id").addEventListener("click", function () {
 ...
 <div class="modal-dialog">
                                  ...
                                  <form id="form-id" action="http://localhost/AJBB/index.php/c_kontak_forum/simpankomentar" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button id="your-id" class="btn btn-primary">Balas</button>
                                        </div>
                                    </div>
                                   </form>
                                </div>
