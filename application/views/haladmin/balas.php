...
<body>
    ...
    <div class="brand">Selamat Datang Admin <br>Sistem Informasi Lokasi Kantor AJB  Bumiputera 
Di Kota Bandung </div>
    ...
    <nav class="navbar navbar-default" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Sistem Informasi Lokasi Kantor AJB  Bumiputera Di Kota Bandung</a>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Sistem Informasi Lokasi Kantor AJB  Bumiputera Di Kota Bandung</h1>
